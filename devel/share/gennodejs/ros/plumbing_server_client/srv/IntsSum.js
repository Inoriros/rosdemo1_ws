...
class IntsSumRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type IntsSumRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type IntsSumRequest
    let len;
    let data = new IntsSumRequest(null);
  ...
  static datatype() {
    ...
    return 'plumbing_server_client/IntsSumRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IntsSumRequest(null);
...
class IntsSumResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type IntsSumResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type IntsSumResponse
    let len;
    let data = new IntsSumResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'plumbing_server_client/IntsSumResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new IntsSumResponse(null);
...
module.exports = {
  Request: IntsSumRequest,
  Response: IntsSumResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'plumbing_server_client/IntsSum'; }
};
